...
public class CustomerController {
    ...
    public boolean update(Customer customer) {
        if (this.getById(customer.getId()) == null) {
            Helper.showAlert(customer.getId() + " | Customer with this ID cannot be found.");
            return false;
        }
    ...
    public boolean delete(int id) {
        if (this.getById(id) == null) {
            Helper.showAlert(id + " | Customer with this ID cannot be found.");
            return false;
        }
    ...
    public ArrayList<Customer> filter(String name, Customer.TYPE_ENUM type) {
